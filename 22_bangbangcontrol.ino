...
#define _DUTY_NEU 1000 // 1500
#define _DUTY_MIN 200 // 1000

#define _SERVO_ANGLE_DIFF  100   // Replace with |D - E| 50 - 120 degree
#define _SERVO_SPEED       300   // servo speed 

// Target Distance
#define _DIST_TARGET    185 // Center of the rail (unit: mm)

// PID parameters
#define _KP  2    // proportional gain
...
float volt_to_distance(int a_value)
{
  // Replace next line into your own equation
   ...
   //return 583 + (-1.96*a_value) + (2.13E-03 * a_value * a_value) + ( -7.83E-07 * (a_value*a_value*a_value)); 
   return 939 + (-4.64*a_value) + (8.43E-03* pow(a_value,2)) + (-5.51E-06 * pow(a_value,3));
